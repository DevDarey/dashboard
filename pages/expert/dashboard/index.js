                        ...
                        <Formik
                            ...
                            {() => (
                                <Form className='flex mb-10 xs:flex-col 2xs:flex-col sm:flex-col'>
                                    <div className='flex-1 flex items-center h-10 px-2 mr-12 rounded-md bg-dashboard-main border-solid border-dashboard-main border-2 text-sm xs:w-full 2xs:w-full sm:w-full xs:mb-4 2xs:mb-4 sm:mb-4 xs:mx-0 2xs:mx-0 sm:mx-0 md:mr-3 lg:mr-3'>
                                        <Field
                                            name='search'
                                    ...
                                    <Field
                                        ...
                                        type='text'
                                        as='select'
                                        className='h-10 w-40 px-2 rounded-md bg-dashboard-main border-solid border-dashboard-main border-2 text-sm mr-3 focus:outline-none xs:w-full 2xs:w-full sm:w-full xs:mb-4 2xs:mb-4 sm:mb-4 xs:mx-0 2xs:mx-0 sm:mx-0'>
