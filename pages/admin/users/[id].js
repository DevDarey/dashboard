        ...
        <AdminLayout>
            ...
            <div className='flex-1 h-full flex flex-col xs:w-full 2xs:w-full sm:w-full md:w-full'>
                ...
                <div className='flex-1 h-full px-4 py-2 overflow-y-auto xs:p-0 2xs:p-0'>
                    ...
                    <div className='w-full py-4 bg-highlight'>
                        <h2 className='text-2xl px-4 text-primary-blue py-3 border-solid border-gray-200 border-b-2'>
                            Bank Details
                        </h2>
                        <div className='py-2 px-4 border-solid border-gray-200 border-b-2 flex'>
                            <p className='w-40 text-primary-blue'>Bank Name:</p>
                            <p className='flex-1 text-gray-400'>Ayodele tunde</p>
                        </div>
                        <div className='py-2 px-4 border-solid border-gray-200 border-b-2 flex'>
                            <p className='w-40 text-primary-blue'>Account nuber:</p>
                            <p className='flex-1 text-gray-400'>0170996287</p>
                        </div>
                        <div className='py-2 px-4 border-solid border-gray-200 border-b-2 flex'>
                            <p className='w-40 text-primary-blue'>Bank:</p>
                            <p className='flex-1 text-gray-400'>Gtbank</p>
                        </div>
                    </div>
                    <div className='w-full px-4 py-4 rounded-sm bg-green-100'>
                        <h2 className='text-primary-blue text-xl mb-4'>BVN VERIFICATION</h2>
                        <p className='text-green-500 mb-3'>
                            <span className='text-primary-blue mr-3'>Status: </span>
                            Verified
                        </p>
