...
function AdminUsers() {
    ...
    return (
        <Fragment>
            <AdminLayout>
                ...
                <div className='flex-1 h-full flex flex-col xs:w-full 2xs:w-full sm:w-full md:w-full'>
                    ...
                    <div className='w-full h-16 px-4 flex items-center justify-between'>
                        <h2 className='text-xl text-primary-blue font-semibold'>Users</h2>
                        {!!users.length && (
                            <button
                                    ...
                                    {() => (
                                        <Form className='w-full flex py-3 xs:flex-col 2xs:flex-col sm:flex-col'>
                                            ...
                                            <Field
                                                ...
                                                type='text'
                                                as='select'
                                                className='w-56 mr-6 h-10 border-solid border-highlight border-2 rounded-md px-2 bg-dashboard-main xs:w-full 2xs:w-full sm:w-full xs:mx-0 2xs:mx-0 sm:mx-0 xs:mb-2 2xs:mb-2 sm:mb-2'>
                                ...
                                <table className='w-full px-4'>
                                    <thead className='w-full'>
                                        <tr className='w-full text-left bg-dashboard-main'>
                                            ...
                                            <th className='w-2/12 h-10 px-2 border-solid border-highlight border-b-2 xs:hidden 2xs:hidden sm:hidden'>
                                                Date
                                            </th>
                                    ...
                                    <tbody>
                                        {users.map((user, index) => (
                                            <tr className='w-full text-left' key={index}>
                                                ...
                                                <td className='w-2/12 h-10 px-2 border-solid border-highlight border-b-2 xs:hidden 2xs:hidden sm:hidden'>
                                                    03-03-2021
                                                </td>
                                                ...
                                                <td className='w-2/12 h-10 pl-2 pr-4 border-solid border-highlight border-b-2 xs:pl-1 2xs:pl-1 sm:pl-1 xs:pr-2 2xs:pr-2 sm:pr-2'>
                                                    <button
                                                        ...
                                                        onClick={() => Router.push('/admin/users/' + (index + 1))}>
                                                        View
                                                    </button>
                                                </td>
                                            </tr>
            ...
            <UsersModal showModal={showModal} setShowModal={setShowModal} users={users} setUsers={setUsers} />
        </Fragment>
    );
}
