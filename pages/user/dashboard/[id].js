            ...
            {type === 'text' ? (
                <div className='w-5/6 h-full flex flex-col xs:w-full 2xs:w-full sm:w-full md:w-full lg:w-3/4'>
                    <div className='w-full h-16 px-4 flex items-center justify-between xs:pl-4 2xs:pl-4 sm:pl-4 xs:pr-16 2xs:pr-16 sm:pr-16 md:pr-16'>
                        <h2 className='text-xl text-primary-blue font-semibold'>Article / Text</h2>
                    ...
                    <div className='flex-1 h-full px-4 py-2 overflow-y-auto'>
                        <div className='w-full min-h-full rounded-sm bg-white px-24 py-6 xs:px-2 2xs:px-2 sm:px-2 md:px-2 lg:px-4'>
                            <h2 className='text-3xl text-primary-blue font-semibold xs:text-lg 2xs:text-xl'>
                            ...
                            <div className='w-full py-2 flex items-center mt-10 xs:flex-col 2xs:flex-col xs:items-start 2xs:items-start'>
                                <img
                                    src='/icons/note-icon.svg'
                                    alt='Notice Icon'
                                    className='w-12 h-12 mr-3 xs:mb-3 2xs:mb-3'
                                />
                                <div className='flex-1 text-gray-800 text-base xs:mb-2 2xs:mb-2'>
                                    <p>Note:</p>
                                    <p>
                                        You are not eligible for any reward if you do not have active paid subscription
                                    </p>
                                </div>
                                <p className='text-base text-primary-blue ml-3 xs:ml-0 2xs:ml-0'>
                                    Summary words: 50/200
                                </p>
                            </div>
                            <form className='flex flex-col' onSubmit={handleSummary}>
                                <textarea
                                    className='w-full h-80 text-gray-800 rounded-sm focus:outline-none px-4 py-3 border-solid border-dashboard-main border-2 xs:h-48 2xs:h-48 xs:p-2 2xs:p-2'
                                ...
                                <button
                                    type='submit'
                                    className='text-white self-end bg-primary-blue text-base py-2 px-16 rounded-md mt-6 focus:outline-none xs:px-6 2xs:px-6 xs:mt-3 2xs:mt-3'>
                                    Submit
                                </button>
                            </form>
                        </div>
                ...
                <div className='w-5/6 h-full flex flex-col xs:w-full 2xs:w-full sm:w-full md:w-full lg:w-3/4'>
                    <div className='w-full h-16 px-4 flex items-center justify-between xs:pl-4 2xs:pl-4 sm:pl-4 xs:pr-16 2xs:pr-16 sm:pr-16 md:pr-16'>
                        <h2 className='text-xl text-primary-blue font-semibold'>Article / Video</h2>
                        <div className='flex items-center'>
                            <img src='/img/user.png' alt='User Logo' className='w-10 h-10 rounded-full mr-2' />
                            <div>
                                <p className='text-base font-semibold'>Ayodele Tunde</p>
                    ...
                    <div className='flex-1 h-full px-4 py-2 overflow-y-auto xs:p-0 2xs:p-0 sm:p-0'>
                        <div className='w-full min-h-full rounded-sm bg-white px-6 py-4 xs:px-2 2xs:px-2 sm:px-2'>
                            <img src='/img/video-player-big.png' alt='Big Video Player' className='w-full h-2/4' />
                            <h2 className='text-primary-blue text-3xl font-medium mt-8 mb-4 xs:text-xl 2xs:text-xl'>
                                AI is Only Going to Get Smarter
                            </h2>
                            <p className='text-lg text-gray-800 mb-10 xs:text-base 2xs:text-base'>
                            ...
                            {showAudio ? (
                                <div className='w-full bg-dashboard-main flex flex-col rounded-sm'>
                                    ...
                                    <div className='w-full flex-1'>
                                        <div className='w-2/5 flex mx-auto flex-col items-center py-10 xs:w-full 2xs:w-full xs:px-4 2xs:px-4 xs:py-3 2xs:py-4 sm:px-4 sm:py-3 md:w-3/5 md:py-4 lg:w-3/5 lg:py-5'>
                                            <img
                                                src='/icons/mic.svg'
                                                alt='Recorder'
                                                className='w-16 h-24 xs:w-10 2xs:w-10 xs:h-16 2xs:h-16 sm:w-10 sm:h-16 md:w-12 md:h-16'
                                            />
                                            <button className='w-full py-3 rounded-md text-white focus:outline-none text-center bg-primary-green my-8 xs:my-3 xs:py-2 2xs:my-3 2xs:py-2 sm:my-3 sm:py-2 md:my-4 md:py-2 '>
                                                START
                                            </button>
                                            <p className='text-gray-400'>Accepted Format:Mp 3,Wav,AAC (up to 4mb)</p>
                                            <button className='w-full py-3 rounded-md text-white focus:outline-none text-center bg-primary-blue my-3 xs:py-2 2xs:py-2 xs:my-2 2xs:my-2 sm:my-2 sm:py-2 md:my-2 md:py-2'>
                                                UPLOAD
                                            </button>
                                ...
                                <div className='w-full bg-dashboard-main flex flex-col rounded-sm'>
                                    ...
                                    <div className='w-full flex-1 px-16 py-8 xs:px-2 2xs:px-2 xs:py-3 2xs:py-3 sm:px-2 sm:py-3 md:px-4 md:py-3 lg:px-4 lg:py-4'>
                                        <form className='w-full flex flex-col' onSubmit={handleAudioSummary}>
                                            <textarea
                                                className='w-full h-96 px-6 py-4 rounded-md text-gray-800 bg-transparent border-solid border-gray-300 border-2 focus:outline-none mb-5 xs:h-48 2xs:h-48 sm:h-64 md:h-64 xs:p-2 2xs:p-2 sm:p-2 md:px-4 md:py-2 xs:mb-2 2xs:mb-2 sm:mb-3 md:mb-4 lg:h-72 lg:px-4 lg:mb-4'
                                                placeholder='Enter your summary here...'
                                                value={audioSummary}
                                                onChange={(e) => setAudioSummary(e.target.value)}
                                            />
                                            <button
                                                className='self-end px-12 py-2 rounded-md bg-primary-blue text-white focus:outline-none xs:px-5 2xs:px-5 sm:px-6 md:px-8 lg:px-8'
                                                type='submit'>
                                                Submit
                                            </button>
                                        </form>
